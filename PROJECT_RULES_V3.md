...
## 🧠 18. SISTEMA DE APRENDIZAGEM CONTÍNUA

Todo agente AI trabalhando neste projeto deve:

✓ **Documentar** padrões descobertos em `.ai-learning/patterns/`
✓ **Reutilizar** soluções comprovadas do banco de conhecimento  
✓ **Aprender** com falhas e documentá-las em `.ai-learning/failures/`
✓ **Evoluir** continuamente com o projeto
✓ **Personalizar** respostas baseado em preferências documentadas
✓ **Compartilhar** conhecimento entre diferentes contextos do projeto

### Aplicação Obrigatória:
- Antes de resolver: Consultar `.ai-learning/solutions/`
- Após resolver: Documentar se success_rate > 0.7
- Semanalmente: Indexar novos aprendizados
- Mensalmente: Calcular métricas de evolução

### Estrutura de Aprendizagem:
```
.ai-learning/
├── patterns/           # Padrões identificados
├── solutions/          # Soluções validadas
├── failures/           # Antipadrões
├── optimizations/      # Melhorias descobertas
└── user-preferences/   # Preferências específicas
```

**Detalhes completos em:** `LEARNING_SYSTEM.md`

**IMPORTANTE:** Este sistema NÃO se aplica a código crítico financeiro (Seção 0.1)
